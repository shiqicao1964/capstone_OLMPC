...
if __name__ == "__main__":
    ...
    ref_mes_dyn = np.genfromtxt(f'CROSSV/ref_mes_{4}.out',delimiter=',')[:,:]
    for i in range(number_files-4):
        #print(i+5)
        ref_mes_R_i = np.genfromtxt(f'CROSSV/ref_mes_{i+5}.out',delimiter=',')[:,:]
    ...
    ax3.plot(ref_mes_dyn[3],ref_mes_dyn[4],ref_mes_dyn[5],color='blue',label='Grid search')
    ax3.plot(ref_mes_R[3],ref_mes_R[4],ref_mes_R[5],color='orange',label='Bayesian optimization')
