...
import math
import time
from MPC_PCA_singleGP import acados_settinngs, linear_quad_model, run_solver,DT_gp_model, DT_linear_model, solve_DT_nextState, eight_trag, ellipse_trag
...
radius = 8
# set traj =================================================================================================================================
x_ref,y_ref,z_ref,t_ref,vx_ref,vy_ref,vz_ref,T_onecircle = ellipse_trag(speed = v_average,x_w = 4,y_w = 4,z_w = 0,H = 5,dT = discretization_dt ,sim_t = 450)
...
def build_new_model():
    ...
    while(1):
        ...
        elif (time.time() - t_comp_start < 220):
            acados_solver = acados_settinngs(model_save[0],t_horizon = t_horizon,N=N)
