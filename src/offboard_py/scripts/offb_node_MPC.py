...
# set traj =================================================================================================================================
x_ref,y_ref,z_ref,t_ref,vx_ref,vy_ref,vz_ref,T_onecircle = ellipse_trag(speed = v_average,x_w = 4,y_w = 4,z_w = 0,H = 3,dT = discretization_dt ,sim_t = 50)
...
acados_solver = acados_settinngs(model_DT,t_horizon = t_horizon,N=N)


solver_save.append(acados_solver)
solver_save.popleft()
model_save.append(model_DT)
model_save.popleft()
        ...
        if (k < 400 or k > 500):
            ...
            if target.shape[0] == N+1:
                ...
                if wind == 0:
                    ...
                    np.savetxt('/home/shiqi/catkin_ws/src/offboard_py/data/MPC_DATA/posrecord_dyn.out',np.array(pos_record).T,delimiter=',')
                    np.savetxt('/home/shiqi/catkin_ws/src/offboard_py/data/MPC_DATA/pos_error_record_dyn.out',np.array(pos_error_record).T,delimiter=',')
                    np.savetxt('/home/shiqi/catkin_ws/src/offboard_py/data/MPC_DATA/ref_mes_dyn.out',np.array(ref_mes).T,delimiter=',')
                if wind == 1:
                    np.savetxt('/home/shiqi/catkin_ws/src/offboard_py/data/MPC_wind/posrecord_dyn.out',np.array(pos_record).T,delimiter=',')
                    np.savetxt('/home/shiqi/catkin_ws/src/offboard_py/data/MPC_wind/pos_error_record_dyn.out',np.array(pos_error_record).T,delimiter=',')
                    np.savetxt('/home/shiqi/catkin_ws/src/offboard_py/data/MPC_wind/ref_mes_dyn.out',np.array(ref_mes).T,delimiter=',')
                print('==========================================================')
                print('===================finished ! =========================')
                print('==========================================================')
                k = 501
