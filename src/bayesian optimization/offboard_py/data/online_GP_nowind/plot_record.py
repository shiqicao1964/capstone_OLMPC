...
if __name__ == "__main__":
    ...
    error_record_n1 = np.genfromtxt('pos_error_record_2.out',delimiter=',')[:,:]
    error_record_1 = np.genfromtxt('pos_error_record_3.out',delimiter=',')[:,:]
    error_record_2 = np.genfromtxt('pos_error_record_4.out',delimiter=',')[:,:]
    error_record_3 = np.genfromtxt('pos_error_record_5.out',delimiter=',')[:,:]
    error_record_4 = np.genfromtxt('pos_error_record_6.out',delimiter=',')[:,:]
    error_record_5 = np.genfromtxt('pos_error_record_7.out',delimiter=',')[:,:]
    error_record_6 = np.genfromtxt('pos_error_record_8.out',delimiter=',')[:,:]
    error_record_7 = np.genfromtxt('pos_error_record_9.out',delimiter=',')[:,:]


    error_record = np.concatenate((error_record_2,error_record_3,error_record_4,error_record_5,error_record_6,error_record_7), axis = 1)
    ...
    #print('max error distance',np.max (np.sqrt(np.sum(error_record_dyn,0))))

    print('mean square error of GP + DYN model : (x , y , z)', np.mean(error_record,1))
    print('average distance error of GP + DYN model :', np.mean(np.sqrt(np.sum(error_record,0))))
    #print('max error distance',np.max (np.sqrt(np.sum(error_record,0))))
    pos_record_n1 = np.genfromtxt('ref_mes_2.out',delimiter=',')[:,:]
    pos_record_1 = np.genfromtxt('ref_mes_3.out',delimiter=',')[:,:]
    pos_record_2 = np.genfromtxt('ref_mes_4.out',delimiter=',')[:,:]
    pos_record_3 = np.genfromtxt('ref_mes_5.out',delimiter=',')[:,:]
    pos_record_4 = np.genfromtxt('ref_mes_6.out',delimiter=',')[:,:]
    pos_record_5 = np.genfromtxt('ref_mes_7.out',delimiter=',')[:,:]
    pos_record_6 = np.genfromtxt('ref_mes_8.out',delimiter=',')[:,:]
    pos_record_7 = np.genfromtxt('ref_mes_9.out',delimiter=',')[:,:]


    ref_mes = np.concatenate((pos_record_2,pos_record_3,pos_record_4,pos_record_5,pos_record_6,pos_record_7), axis = 1)
